      ...
      >
        ...
        <div className="max-w-5xl mx-auto text-center space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            {[
              {
                icon: <img className='h-11 drop-shadow-md' src='./images/gmail.webp'/>,
                title: 'Email Us',
                content: (
              ...
              {
                icon: <img className='h-11 drop-shadow-md' src='./images/call.webp'/>,
                title: 'Call Us',
                content: (
                  <>
              ...
              {
                icon: <img className='h-11 drop-shadow-md' src='./images/loc.webp'/>,
                title: 'Visit Us',
                content: (
